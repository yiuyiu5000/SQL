...
#define MSG_GOSSIP_BUY "Buy GuildHouse (1 GuildHouse Token)"
#define MSG_GOSSIP_SELL "Sell GuildHouse (1 copper. If you wish to swap your GH please contact an Admin.)"
...
#define COST_GH_BUY 1 //1 c.
#define COST_GH_SELL 1 //1 c.
...
bool showBuyList(Player *player, Creature *_creature, uint32 showFromId = 0)
{
 ...
 if(player->HasItemCount(909090, 1))
 {
...
void buyGuildhouse(Player *player, Creature *_creature, uint32 guildhouseId)
{
 ...
 player->DestroyItemCount(909090, 1, true, false);
