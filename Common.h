...
enum AccountTypes
{
	...
	SEC_VIPPLUS        = 2,
	SEC_TRIALGM        = 3,
	SEC_MODERATOR      = 4,	//not used. Creates a break in the ranks.
	SEC_GAMEMASTER     = 5,
	SEC_TRIALDEV       = 6,
	SEC_TRIALADMIN     = 7,
	SEC_HEADGM		   = 8,
	...
	SEC_COREDEV        = 14,
	SEC_HEADDEV		   = 15,
	SEC_ADMINISTRATOR  = 16, //Always has to be before console and called admin. This is the founder ranks.
    SEC_CONSOLE        = 17  // must be always last in list, accounts must have less security level always also
};
